...
type Config struct {
	Zap ZapInfo `mapstructure:"zap" json:"zap" yaml:"zap"`
}
...
func (c *ZapInfo) Levels() []zapcore.Level {
...
func (c *ZapInfo) Encoder() zapcore.Encoder {
...
func (c *ZapInfo) LevelEncoder() zapcore.LevelEncoder {
	switch {
